...
class __TwigTemplate_26212e8c13e026fcb45efa22a6876d2e8563ee9868f759b22dc4cac04a7265d1 extends \Twig\Template
{
...
";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["name"]) {
            ...
            // line 12
            echo "    ";
            $context["value"] = $this->env->getExtension('Grav\Common\Twig\Extension\GravExtension')->arrayFilter(((($this->getAttribute(($context["form"] ?? null), "value", [0 => ($context["field_name"] ?? null)], "method", true, true) &&  !(null === $this->getAttribute(($context["form"] ?? null), "value", [0 => ($context["field_name"] ?? null)], "method")))) ? ($this->getAttribute(($context["form"] ?? null), "value", [0 => ($context["field_name"] ?? null)], "method")) : (((($this->getAttribute(($context["data"] ?? null), "value", [0 => ($context["field_name"] ?? null)], "method", true, true) &&  !(null === $this->getAttribute(($context["data"] ?? null), "value", [0 => ($context["field_name"] ?? null)], "method")))) ? ($this->getAttribute(($context["data"] ?? null), "value", [0 => ($context["field_name"] ?? null)], "method")) : (((($this->getAttribute(($context["default"] ?? null), $context["name"], [], "array", true, true) &&  !(null === $this->getAttribute(($context["default"] ?? null), $context["name"], [], "array")))) ? ($this->getAttribute(($context["default"] ?? null), $context["name"], [], "array")) : ([])))))));
            // line 13
            echo "    ";
    ...
    ";
            // line 23
            $context["field"] = ["type" => "select", "classes" => "fancy create", "label" => twig_capitalize_string_filter($this->env,             // line 26
$context["name"]), "name" =>             // line 27
($context["field_name"] ?? null), "multiple" => true, "options" =>             // line 29
($context["list"] ?? null), "style" => $this->getAttribute(            // line 30
($context["field"] ?? null), "style", []), "selectize" => ["create" => true]];
            // line 35
            echo "
    ";
            // line 36
            $this->loadTemplate([0 => "forms/fields/select/select.html.twig"], "forms/fields/taxonomy/taxonomy.html.twig", 36)->display($context);
            ++$context['loop']['index0'];
            ++$context['loop']['index'];
    ...
    {
        return array (  117 => 36,  114 => 35,  112 => 30,  111 => 29,  110 => 27,  109 => 26,  108 => 23,  105 => 22,  102 => 21,  99 => 20,  96 => 19,  93 => 18,  90 => 17,  87 => 16,  84 => 15,  81 => 14,  78 => 13,  75 => 12,  72 => 11,  55 => 10,  52 => 9,  50 => 8,  48 => 7,  46 => 6,  44 => 5,  42 => 4,  39 => 3,  29 => 1,);
    }
...
{% endfor %}
{% endblock %}
", "forms/fields/taxonomy/taxonomy.html.twig", "C:\\wamp64\\www\\dmdExhibitions\\user\\plugins\\admin\\themes\\grav\\templates\\forms\\fields\\taxonomy\\taxonomy.html.twig");
    }
}
