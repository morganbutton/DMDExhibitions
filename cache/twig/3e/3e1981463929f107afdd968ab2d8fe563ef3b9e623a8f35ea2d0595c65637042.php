...
class __TwigTemplate_7aab59a86501b22da3025d8b1e1ea7c6bd9e5c3c0c472228e282c32de610d79a extends \Twig\Template
{
    ...
    ";
            ...
            if ($this->getAttribute(($context["field"] ?? null), "text", [])) {
                ...
                echo "    <p>";
                if ($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute(($context["grav"] ?? null), "twig", [], "any", false, true), "twig", [], "any", false, true), "filters", [], "any", false, true), "tu", [], "array", true, true)) {
                    echo $this->env->getExtension('Grav\Common\Twig\Extension\GravExtension')->markdownFunction($context, $this->env->getExtension('Grav\Plugin\Admin\Twig\AdminTwigExtension')->tuFilter($this->getAttribute(($context["field"] ?? null), "text", [])));
                } else {
...
{% endif %}
{% endblock %}
", "forms/fields/section/section.html.twig", "C:\\wamp64\\www\\dmdExhibitions\\user\\plugins\\admin\\themes\\grav\\templates\\forms\\fields\\section\\section.html.twig");
    }
}
