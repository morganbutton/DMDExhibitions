...
class __TwigTemplate_b61447e9fcd19d1e326b126c00d21652793ee1ddac5895cb783417a1f398f11c extends \Twig\Template
{
    ...
    ";
        ...
        if (($this->env->getExtension('Grav\Common\Twig\Extension\GravExtension')->authorize([0 => "admin.super"]) && $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute(($context["config"] ?? null), "plugins", []), "admin", []), "whitelabel", []), "quicktray_recompile", []))) {
            // line 11
            echo "        <li class=\"hint--bottom\" data-hint=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('Grav\Plugin\Admin\Twig\AdminTwigExtension')->tuFilter("PLUGIN_ADMIN.QUICKTRAY_RECOMPILE_HELP"), "html", null, true);
            echo "\">
...
", "partials/nav-quick-tray.html.twig", "C:\\wamp64\\www\\dmdExhibitions\\user\\plugins\\admin\\themes\\grav\\templates\\partials\\nav-quick-tray.html.twig");
    }
}
