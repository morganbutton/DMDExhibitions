...
class __TwigTemplate_3762cff00a11ab560b8d4e633e2d4ef90a489788230be4e12d00067b9d02436e extends \Twig\Template
{
...
";
        ...
        if ((($context["lazy_load"] ?? null) == true)) {
            ...
            echo twig_escape_filter($this->env, $this->env->getExtension('Grav\Plugin\Youtube\Twig\YoutubeTwigExtension')->thumbnailUrl(($context["video_id"] ?? null)), "html", null, true);
            echo "')\">
      <iframe data-src=\"";
            // line 4
...
{% endif %}
</div>", "partials/youtube.html.twig", "C:\\wamp64\\www\\dmdExhibitions\\user\\plugins\\youtube\\templates\\partials\\youtube.html.twig");
    }
}
