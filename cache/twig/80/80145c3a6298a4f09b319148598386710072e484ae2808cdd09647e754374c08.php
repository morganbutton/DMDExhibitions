...
class __TwigTemplate_a0efab059cfd43a6311d536b932dc6f0e04a7c6da81c1a2e198aa0f2e0841f40 extends \Twig\Template
{
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["field"]) {
            ...
            if ($this->getAttribute($context["field"], "type", [])) {
                // line 7
                echo "            ";
                $context["value"] = (($this->getAttribute($context["field"], "name", [])) ? (((($this->getAttribute(($context["data"] ?? null), "value", [0 => $this->getAttribute($context["field"], "name", [])], "method", true, true) &&  !(null === $this->getAttribute(($context["data"] ?? null), "value", [0 => $this->getAttribute($context["field"], "name", [])], "method")))) ? ($this->getAttribute(($context["data"] ?? null), "value", [0 => $this->getAttribute($context["field"], "name", [])], "method")) : ($this->getAttribute(($context["form"] ?? null), "value", [0 => $this->getAttribute($context["field"], "name", [])], "method")))) : ($this->getAttribute(($context["data"] ?? null), "toArray", [])));
                // line 8
                ...
                ";
                // line 9
                $this->loadTemplate([0 => (((("forms/fields/" . $this->getAttribute($context["field"], "type", [])) . "/") . $this->getAttribute($context["field"], "type", [])) . ".html.twig"), 1 => "forms/fields/text/text.html.twig"], "partials/blueprints-copy.html.twig", 9)->display($context);
                // line 10
                echo "            </div>
        ";
            }
...
";
    ...
    {
        return array (  114 => 20,  107 => 17,  101 => 13,  87 => 12,  83 => 10,  81 => 9,  76 => 8,  73 => 7,  70 => 6,  53 => 5,  37 => 4,  34 => 3,  32 => 2,  30 => 1,);
    }
...
", "partials/blueprints-copy.html.twig", "C:\\wamp64\\www\\dmdExhibitions\\user\\plugins\\admin\\themes\\grav\\templates\\partials\\blueprints-copy.html.twig");
    }
}
