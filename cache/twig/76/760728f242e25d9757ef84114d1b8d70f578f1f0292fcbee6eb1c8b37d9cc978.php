...
class __TwigTemplate_ee4d35187a2f452dd2d0d73eef622e36ae3aa379c59998fd7ef763237c4c4a86 extends \Twig\Template
{
    ...
    <template data-id=\"acl_picker-";
        ...
        if (($this->getAttribute(($context["field"] ?? null), "data_type", []) == "access")) {
            ...
            echo twig_escape_filter($this->env, ($this->getAttribute(($context["field"] ?? null), "name", []) . "_"), "html", null, true);
            echo "\">";
            echo twig_escape_filter($this->env, ((($context["tu"] ?? null)) ? ($this->env->getExtension('Grav\Plugin\Admin\Twig\AdminTwigExtension')->tuFilter("PLUGIN_ADMIN.ALLOWED")) : ($this->env->getExtension('Grav\Common\Twig\Extension\GravExtension')->translate($this->env, "PLUGIN_ADMIN.ALLOWED"))), "html", null, true);
            echo "</label>
            ...
            echo twig_escape_filter($this->env, ($this->getAttribute(($context["field"] ?? null), "name", []) . "_"), "html", null, true);
            echo "\">";
            echo twig_escape_filter($this->env, ((($context["tu"] ?? null)) ? ($this->env->getExtension('Grav\Plugin\Admin\Twig\AdminTwigExtension')->tuFilter("PLUGIN_ADMIN.DENIED")) : ($this->env->getExtension('Grav\Common\Twig\Extension\GravExtension')->translate($this->env, "PLUGIN_ADMIN.DENIED"))), "html", null, true);
            echo "</label>
...
{% endblock %}
", "forms/fields/acl_picker/acl_picker.html.twig", "C:\\wamp64\\www\\dmdExhibitions\\user\\plugins\\admin\\themes\\grav\\templates\\forms\\fields\\acl_picker\\acl_picker.html.twig");
    }
}
